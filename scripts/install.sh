...
info "Instalando Node.js, npm y Nginx"
eval "$PKG_INSTALL nginx nodejs npm"
...
info "Listo. Ejecuta 'npm start' dentro de app o crea un servicio systemd si lo deseas."
